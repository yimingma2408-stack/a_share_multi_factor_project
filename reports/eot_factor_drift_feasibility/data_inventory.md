...
- Python scripts: `scripts/baostock_hs300_downloader_fixed.py`, `scripts/download _stocks_baostocks.py`, `scripts/download_stock_akshare.py`, `scripts/download_stocks_efinance.py`, `scripts/factors.py`, `scripts/run_eot_factor_drift_feasibility.py`, `scripts/test.py`
- Raw root files: 305 files
- Raw market parquet files: 1254 files
- Processed files: `data/processed/.gitkeep`, `data/processed/clean_daily_data.csv`, `data/processed/eot_factor_drift_backtest_nav.parquet`, `data/processed/eot_factor_drift_scores.parquet`, `data/processed/hs300_dynamic_panel_20160101_20251231_baostock.parquet`, `data/processed/hs300_member_sample_20160101_20251231_baostock.parquet`, `data/processed/monthly_factor_performance.parquet`, `data/processed/monthly_factor_weights.parquet`
